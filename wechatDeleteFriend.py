...
def showQRImage():
    ...
    print('please scan qrcode to login in with your Wechat APP')
...
def waitForLogin():
    ...
    if code == '201':  # 已扫描
        print('Scan success,press confirm to login in on the phone')
        tip = 0
    elif code == '200':  # 已登录
        print('loading...')
...
def main():
    ...
    MemberCount = len(MemberList)
    print('Amount %s friends' % MemberCount)
    ...
    for i in range(0, group_num):
        ...
        print('New Find you were delete by %d friends' % DeletedCount)
